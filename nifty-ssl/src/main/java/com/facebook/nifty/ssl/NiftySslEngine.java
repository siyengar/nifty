 ...
 *
 * This code is taken from netty 3's OpenSSLEngine
 * https://github.com/netty/netty/blob/3.10/src/main/java/org/jboss/netty/handler/ssl/OpenSslEngine.java
 * With modifications so that we can use new methods for tuning buffer sizes. We should be able to get
 * rid of this once we move to Netty 4.
 */
public final class NiftySslEngine extends SSLEngine {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(NiftySslEngine.class);
    ...
    private static final AtomicIntegerFieldUpdater<NiftySslEngine> DESTROYED_UPDATER =
            AtomicIntegerFieldUpdater.newUpdater(NiftySslEngine.class, "destroyed");
     ...
     */
    public NiftySslEngine(long sslCtx, SslBufferPool bufPool, String fallbackApplicationProtocol, int bioSize) {
        ...
        networkBIO = SSL.makeNetworkBIOWithSize(ssl, bioSize);
    ...
    /**
     * Write plaintext data to the Open SL internal BIO
     *
    ...
    public synchronized SSLEngineResult unwrap(
        ...
        if (error != null && !error.startsWith(IGNORABLE_ERROR_PREFIX)) {
        ...
        if (session == null) {
            this.session = session = new SSLSession() {
                ...
                public String getProtocol() {
                    ...
                    String applicationProtocol = NiftySslEngine.this.applicationProtocol;
